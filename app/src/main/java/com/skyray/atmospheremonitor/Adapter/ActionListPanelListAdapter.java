package com.skyray.atmospheremonitor.Adapter;
...
import com.skyray.atmospheremonitor.R;
...
public class ActionListPanelListAdapter extends PanelListAdapter {
     ...
     */
    public ActionListPanelListAdapter(Context context, PanelListLayout pl_root, ListView lv_content,
    ...
    private class ContentAdapter extends ArrayAdapter {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            viewHolder.tv_01.setText(data.get("0"));
            viewHolder.tv_02.setText(data.get("1"));
            viewHolder.tv_03.setText(data.get("2"));
            viewHolder.tv_04.setText(data.get("3"));
            viewHolder.tv_05.setText(data.get("4"));
            viewHolder.tv_06.setText(data.get("5"));
            viewHolder.tv_07.setText(data.get("6"));
            viewHolder.tv_08.setText(data.get("7"));
            viewHolder.tv_09.setText(data.get("8"));
            viewHolder.tv_10.setText(data.get("9"));
            viewHolder.tv_11.setText(data.get("10"));
            viewHolder.tv_12.setText(data.get("11"));
            viewHolder.tv_13.setText(data.get("12"));
            viewHolder.tv_14.setText(data.get("13"));
