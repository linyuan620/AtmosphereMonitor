 ...
 */
public class LogInitialHeaderAdapter implements StickyHeadersAdapter<LogInitialHeaderAdapter.ViewHolder> {

    private List<String> items;

    public LogInitialHeaderAdapter(List<String> items) {
        this.items = items;
    }
